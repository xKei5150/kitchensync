...
///
/// Several category hues are deliberately light pastels (dairy `#FFF176`,
/// produce, beverage, frozen…). Used raw as icon or tag text they wash out on a
/// light surface — and using the luminance-lifted dark variant only makes them
/// brighter. This pulls a too-bright ink down (light surface) or lifts a
/// too-dim one up (dark surface) so category glyphs and tag labels stay
/// readable while keeping their identifying hue.
